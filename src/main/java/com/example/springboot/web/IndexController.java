...
public class IndexController {
    ...
    public String index(Model model, @LoginUser SessionUser user){
        // send list of Posts through the model so that it can be used by server template engine
        model.addAttribute("posts", postsService.findAllDesc());

        // Get user through @LoginUser instead
        ...
        // view resolver looks for files with .mustache extension
        return "index"; // returns src/main/resources/templates/index.mustache
    }
